...
class MiniCourt():
    def __init__(self,frame):
        self.drawing_rectangle_width = 250 #change this to change width of minimap
        self.drawing_rectangle_height = 500 #change this to change height of minimap
        self.buffer = 50 #buffer between the minimap and the screen edge
        self.padding_court=20 #padding between the minimap and the white background
    ...
    def set_court_drawing_key_points(self):
        #Set the position of each keypoint on the minimap background
    ...
    def set_mini_court_position(self):
        #Set the position of the minimap background
    ...
    def draw_background_rectangle(self,frame):
        ...
        # Draw the rectangle white background
    ...
    def draw_court(self,frame):
        for i in range(0, len(self.drawing_key_points),2):
            ...
            cv2.circle(frame, (x,y),5, (0,0,255),-1) # -1 is the same as cv2.FILLED

...
def main():
    ...
    ## Choose the players based on how close they are to the keypoints
    player_detections = player_tracker.choose_and_filter_players(court_keypoints, player_detections)

    # Initilize the MiniCourt Class
    ...
    # Convert positions to minimap position
    ...
    ## Draw Court Keypoints Bounding Boxes
